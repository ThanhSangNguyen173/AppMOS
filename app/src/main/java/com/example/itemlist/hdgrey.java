...
public class hdgrey extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hdgrey_page);
        anhxa();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(hdgrey.this,listitem.class);
        ...
        buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(edtslg.getText().toString().isEmpty()||edtslg.getText().toString().equals("0")){
                    Toast.makeText(hdgrey.this, "Vui lòng nhập số lượng", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent2 = new Intent(hdgrey.this, DkyPage.class);
