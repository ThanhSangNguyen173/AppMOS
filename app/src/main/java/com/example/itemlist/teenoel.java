...
public class teenoel extends AppCompatActivity {
    Button buy,back;
    RadioButton m,l,xl;
    EditText edtslg;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teenoel_page);
        anhxa();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(teenoel.this,listitem.class);
        ...
        buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(edtslg.getText().toString().isEmpty()||edtslg.getText().toString().equals("0")){
                    Toast.makeText(teenoel.this, "Vui lòng nhập số lượng", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent2 = new Intent(teenoel.this, DkyPage.class);
